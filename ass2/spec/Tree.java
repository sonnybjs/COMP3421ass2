...
public class Tree {
    ...
    public void draw(GL2 gl, Texture treeTexture){
        ...
        treeTexture.bind(gl);  // same as gl.glBindTexture(texture.getTarget(), texture.getTextureObject());
		...
		glu.gluCylinder(cylinder , treeRadius, treeRadius, treeHeight, 5, 10);
		 gl.glNormal3f( 0.0f, 0.0f, 1.0f);                              // front face points out of the screen on z.
